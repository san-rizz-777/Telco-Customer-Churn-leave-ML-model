...
def validate_data(df: pd.DataFrame) -> Tuple[bool, List[str]]:
    """
    Comphrehensive  data validation of dataset by great expectations.

    This function implements "data quality" checks before model training.
    It validates the data integrity, business logic constraints and statistical properties that ML model expects.
    """
    ...
    print("Validating the business logic constraints...")
    ...
    print("Validating the data consistency...")
    ...
    if results["success"]:
        print(f"Data validation passed :- {passed_checks} checks passed out of {total_checks} total checks.")
    else:
        print(f"Data validation failed :- {failed_checks} checks failed out of {total_checks} total checks.")
